...
This project begins with a simulation of a realistic business case and is split into 3 parts: 
...
*MIT License: Free to use with appropriate attribution. This repo is based on project from Data With Baraa (shout out to Baraa Khatib Salkini, an excellent digital mentor!)*
